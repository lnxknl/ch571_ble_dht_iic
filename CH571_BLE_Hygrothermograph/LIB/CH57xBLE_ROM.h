...
#define  BLE_LIB_RAM_JT(n) (*(uint32_t*)( RAM_BASE_ADDRESSS+n*4 ))// @NOTE //ch577 not like stm32 open source code,the stack is encrypted
 ...
 * @return  None.
 */
#define    TMOS_SystemProcess  ((  void  (*)  ( void ))  BLE_LIB_RAM_JT(0))// @NOTE 
